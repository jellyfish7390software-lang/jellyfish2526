...
public final class PinpointLocalizerPurePursuit implements Localizer {
    public static class Params {
        public double parYTicks = 2684.2476579963604; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3173.1274259449083; // x position of the perpendicular encoder (in tick units)
    }
